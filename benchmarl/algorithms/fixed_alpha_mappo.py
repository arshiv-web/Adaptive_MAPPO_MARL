...
class FixedAlphaMappo(Algorithm):
    ...
    def get_critic(self, group: str) -> TensorDictModule:
        ...
        lambda v_global, v_local: self.alpha * v_global + (1 - self.alpha) * v_local,
...
@dataclass
class FixedAlphaMappoConfig(AlgorithmConfig):
    """Configuration dataclass for :class:`~benchmarl.algorithms.FixedAlphaMappo`."""
